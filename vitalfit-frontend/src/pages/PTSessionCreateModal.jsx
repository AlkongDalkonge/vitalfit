  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="w-[554px] h-[600px] relative bg-white rounded-lg overflow-hidden">
        ...
        {/* 멤버 정보 표시 */}
        {member && (
          <div className="absolute left-[38px] top-[40px] w-[478px] p-3 bg-gray-50 rounded-lg">
            <div className="text-sm text-gray-600">
              <span className="font-medium">회원:</span> {member.name}
              {member.trainer && (
                <span className="ml-4">
                  <span className="font-medium">담당 트레이너:</span> {member.trainer.name}
                </span>
              )}
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit}>
          {/* PT 일자 */}
          <div className="absolute left-[38px] top-[95px] w-[478px] flex flex-col gap-2">
          ...
          {/* 세션 유형 */}
          <div className="absolute left-[38px] top-[185px] w-[478px] flex flex-col gap-2">
            <label className="text-neutral-900 text-sm font-normal font-['Nunito']">
              세션 유형
            </label>
          ...
          {/* 시작 시간 */}
          <div className="absolute left-[38px] top-[275px] w-[230px] flex flex-col gap-2">
            <label className="text-neutral-900 text-sm font-normal font-['Nunito']">
          ...
          {/* 종료 시간 */}
          <div className="absolute right-[38px] top-[275px] w-[230px] flex flex-col gap-2">
            <label className="text-neutral-900 text-sm font-normal font-['Nunito']">
          ...
          {/* 내용/메모 */}
          <div className="absolute left-[38px] top-[365px] w-[478px] flex flex-col gap-2">
            <label className="text-neutral-900 text-sm font-normal font-['Nunito']">
              내용/메모
            </label>
            <textarea
          ...
          {/* 에러 메시지 */}
          {errors.submit && (
            <div className="absolute left-[38px] top-[495px] text-red-500 text-sm">
              {errors.submit}
            </div>
          )}
