...
import { canPerformAction, getPermissionMessage, getDetailedPermissionMessage } from '../utils/permissionUtils';
                            ...
                            <div>
                              ...
                              <div className="mb-4">
                                <ImageUploader
                                  ...
                                  disabled={imageUploading[center.id] || !canPerformAction(currentUser)}
                                />
                              </div>
