...
export default function Header({ activeMenu = null, userInfo, className = '' }) {
  ...
  return (
    <header className={`h-16 flex justify-between items-center px-8 ${isDashboard ? 'bg-transparent border-transparent' : 'bg-white border-b border-gray-100'} ${className}`}>
