...
// ✅ 센터 등록
// POST /api/centers
router.post('/', requireCenterManagerPermission, validateRequest(createCenterSchema), centerController.createCenter);
...
router.post('/images', requireCenterManagerPermission, centerController.upload.single('image'), centerController.uploadCenterImage);

// ✅ 센터 이미지 삭제 (ID 라우트보다 먼저 정의)
// DELETE /api/centers/images/:imageId
router.delete('/images/:imageId', requireCenterManagerPermission, centerController.deleteCenterImage);
